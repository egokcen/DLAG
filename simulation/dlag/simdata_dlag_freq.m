function [seq, params] = simdata_dlag_freq(N, T, binWidth, yDims, ...
    xDim_across, xDim_within, snr, covType, param_lims, varargin)
% [seq, params] = simdata_dlag_freq(...)
%
...
%              DLAG generative model. Sequences are generated approximately
%              in the frequency domain. The true covariances are thus 
%              circulant.
%
% Arguments:
%
...
seq = generate_obs_dlag(seq, params, 'latentfield', timefield, ...
                        'obsfield', obsfield);