function dlagEngine_freq(seqTrain,seqTest,fname,varargin)
%
% dlagEngine_freq(seqTrain,seqTest,fname,...)
%
% Description: Initialize and fit DLAG model parameters via a frequency
%              domain approximation; infer latent time courses; and assess
%              generalization performance, if cross-validating. 
